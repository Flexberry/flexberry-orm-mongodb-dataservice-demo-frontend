...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('EventE', 'new-platform-flexberry-orm-mongo-db-data-service-demo-event', {
  ...
  modelClass.defineProjection('EventL', 'new-platform-flexberry-orm-mongo-db-data-service-demo-event', {
    typeid: Projection.attr('Typeid'),
    photo_id: Projection.attr('Photo_id'),
    timestamp: Projection.attr('Timestamp'),
    datetime: Projection.attr('Datetime'),
