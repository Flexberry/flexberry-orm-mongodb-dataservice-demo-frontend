...
moduleForModel('ember-flexberry-dummy-graduate-record', 'Unit | Serializer | ember-flexberry-dummy-graduate-record', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-graduate-record',
    'transform:file',
    'transform:decimal',
