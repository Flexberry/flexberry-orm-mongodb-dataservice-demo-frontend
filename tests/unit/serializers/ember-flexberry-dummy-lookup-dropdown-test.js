...
moduleForModel('ember-flexberry-dummy-lookup-dropdown', 'Unit | Serializer | ember-flexberry-dummy-lookup-dropdown', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-lookup-dropdown',
    'transform:file',
    'transform:decimal',
