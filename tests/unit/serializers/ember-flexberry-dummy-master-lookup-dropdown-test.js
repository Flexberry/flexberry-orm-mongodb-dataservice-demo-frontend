...
moduleForModel('ember-flexberry-dummy-master-lookup-dropdown', 'Unit | Serializer | ember-flexberry-dummy-master-lookup-dropdown', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-master-lookup-dropdown',
    'transform:file',
    'transform:decimal',
