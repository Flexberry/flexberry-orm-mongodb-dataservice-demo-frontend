...
moduleForModel('ember-flexberry-dummy-lazy-loading-detail', 'Unit | Serializer | ember-flexberry-dummy-lazy-loading-detail', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-lazy-loading-detail',
    'transform:file',
    'transform:decimal',
