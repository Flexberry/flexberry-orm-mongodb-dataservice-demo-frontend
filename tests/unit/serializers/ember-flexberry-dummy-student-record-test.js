...
moduleForModel('ember-flexberry-dummy-student-record', 'Unit | Serializer | ember-flexberry-dummy-student-record', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-student-record',
    'transform:file',
    'transform:decimal',
