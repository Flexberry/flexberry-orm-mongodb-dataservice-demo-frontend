...
moduleForModel('ember-flexberry-dummy-successor-phone', 'Unit | Serializer | ember-flexberry-dummy-successor-phone', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-successor-phone',
    'transform:file',
    'transform:decimal',
