...
moduleForModel('ember-flexberry-dummy-lazy-loading-master', 'Unit | Serializer | ember-flexberry-dummy-lazy-loading-master', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-lazy-loading-master',
    'transform:file',
    'transform:decimal',
