...
moduleForModel('ember-flexberry-dummy-successor-social-network', 'Unit | Serializer | ember-flexberry-dummy-successor-social-network', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-successor-social-network',
    'transform:file',
    'transform:decimal',
