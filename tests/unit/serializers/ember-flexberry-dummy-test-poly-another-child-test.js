...
moduleForModel('ember-flexberry-dummy-test-poly-another-child', 'Unit | Serializer | ember-flexberry-dummy-test-poly-another-child', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-test-poly-another-child',
    'transform:file',
    'transform:decimal',
